...
RSpec.describe "Auto Dealership index page" do

  # User Story 1, Parent Index
  # When I visit '/auto_dealerships'
  # Then I see the name of each parent record in the system
  it "displays all Auto Dealerships" do
  ...
  it "displays all Auto Dealerships and corresponding timestamp, ordered by most recently created" do

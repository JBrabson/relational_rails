...
music_store_3 = MusicStore.create!(name: "Henry's Fancy Music Store", rents: false, lesson_cost: 70)
music_store_4 = MusicStore.create!(name: "Music On The Cheap", rents: true, lesson_cost: 20)
